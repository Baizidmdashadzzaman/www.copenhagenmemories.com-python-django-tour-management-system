...
urlpatterns = [
    ...
    path('dashboard/supplier/tours/<int:tour_id>/view/', supplier_views.supplier_tour_view, name='supplier_tour_view'),
    path('dashboard/supplier/tours/<int:tour_id>/edit/', supplier_views.supplier_tour_edit, name='supplier_tour_edit'),
    path('dashboard/supplier/tours/<int:tour_id>/delete/', supplier_views.supplier_tour_delete, name='supplier_tour_delete'),
    ...
    path('admin/souvenir-orders/<int:pk>/edit/', souvenir_views.souvenir_order_edit, name='souvenir_order_edit'),
